...
Examples:
  ...
  ### Use sub-function and after hook
  Some times it's convenient to not output anything until all entries have been processed. This can be done with --after

  cat some_data.ndjson | ndjson-apply reduce.mjs aggregate --after outputAggragatedResult > aggragated_result.json
